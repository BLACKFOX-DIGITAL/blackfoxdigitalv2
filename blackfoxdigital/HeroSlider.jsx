...
function HeroSlider({ go }) {
  ...
  const scenes = [
    { title: "High-end skin retouch", tag: "Beauty & Skin", sid: "beauty",    pair: "beauty2",   fit: "cover",   bg: "#1a1714" },
    { title: "Color correction",      tag: "Color",         sid: "beauty",    pair: "color",     fit: "cover",   bg: "#1a1714" },
    { title: "Ghost mannequin",       tag: "Apparel",       sid: "mannequin", pair: "mannequin", fit: "contain", bg: "#15130f" },
    { title: "Product & e-commerce",  tag: "E-commerce",    sid: "ecom",      pair: "ecom",      fit: "cover",   bg: "#1a1714" },
    { title: "Photo editing",         tag: "Manipulation",  sid: "masking",   pair: "masking",   fit: "cover",   bg: "#15130f" },
  ];
          ...
          return (
            <div className={"hslide scene" + (active ? " active" : "")} key={s.title} style={{ background: s.bg }}>
              <div className="scene-ba">
                {active && (
                  <BA before={BF.pairs[s.pair].before} after={BF.pairs[s.pair].after} ratio="auto" start={0.5} afterFit={s.fit} afterBg={s.bg} beforeLabel="Raw" afterLabel="Edited" auto autoDelay={500} style={{ height: "100%", aspectRatio: "auto" }} />
                )}
              </div>
