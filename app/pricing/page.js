...
export const metadata = {
  ...
  description:
    "Transparent per-image pricing for all photo editing services. Background removal from €0.25, ghost mannequin from €0.85, jewelry retouch from €3.50. Volume discounts up to 20%.",
