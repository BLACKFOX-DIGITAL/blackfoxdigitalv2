...
export const metadata = {
  title: "Ghost Mannequin & Invisible Mannequin Service",
  description:
...
export default function Page() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Ghost Mannequin Service", item: "https://blackfoxdigital.com.bd/ghost-mannequin" },
    ],
  };
