          ...
          <div className="ah2-grid">
            <div className="ah2-copy">
              ...
              <p className="lede ah2-lede">
                ...
                commerce brands, photographers and agencies across the UK, Germany, France, the Netherlands, Italy and beyond.
              </p>
            ...
            <div className="ah2-media reveal">
              ...
              <div className="ah2-ba">
                <BA before={BF.pairs.model.before} after={BF.pairs.model.after} ratio="4 / 5" start={0.5} afterFit="cover" beforeLabel="Raw" afterLabel="Edited" beforeAlt="Model photo — raw unedited shot" afterAlt="Model photo — professionally retouched result" auto autoDelay={600} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="shell about-story">
          <div className="about-copy">
            ...
            <div className="founders">
              {BF.about.founders.map((f) => (
                <a key={f.name} href={f.linkedin} target="_blank" rel="noopener noreferrer" className="founder-card">
          ...
          <div className="about-media reveal">
            <div className="about-media-inner">
              <BA before={BF.pairs.beauty.before} after={BF.pairs.beauty.after} ratio="4 / 5" start={0.5} afterFit="cover" beforeLabel="Raw" afterLabel="Retouched" beforeAlt="Beauty retouch — raw unedited photo" afterAlt="Beauty retouch — professionally retouched result" auto autoDelay={500} />
            </div>
      ...
      <section className="sec" style={{ background: "var(--bg-2)" }}>
        <div className="shell about-global">
          <div className="ag-copy">
            ...
            <p className="lede">
              Headquartered in Dhaka, we deliver world-class post-production
              to clients across Europe — UK, Germany, France, the Netherlands, Italy, Scandinavia and beyond.
            </p>
          </div>
      ...
      <section style={{ padding: "0 0 clamp(64px,9vw,120px)" }}>
        <div className="shell">
          <div className="cta-band reveal">
            <h2 className="display">Let's edit your<br/>first five free.</h2>
      ...
      <section className="sec" style={{ paddingTop: "clamp(28px,4vw,48px)" }}>
        <div className="shell">
          <div className="svc-cards">
            {BF.services.map((s) => {
              const galleryItem = BF.serviceGallery.find(g => g.sid === s.id);
              const beforeImg = galleryItem ? galleryItem.before : BF.pairs[s.pair].before;
              const afterImg = galleryItem ? galleryItem.after : BF.pairs[s.pair].after;
              
              return (
              <div className="svc-card reveal" style={{ cursor: "pointer" }} key={s.id} onClick={(e) => { if (!e.defaultPrevented) { go("service", { serviceId: s.id }); } }}>
                <div className="svc-card-media">
                  <BA before={beforeImg} after={afterImg} ratio="4 / 3" start={0.5} afterFit={s.fit || "cover"} beforeLabel="Before" afterLabel="After" beforeAlt={`${s.short} — before editing`} afterAlt={`${s.short} — after editing`} />
                </div>
        ...
        <div className="shell">
          <div className="gal-grid">
            {pairs.map((p, i) => {
              ...
              const galleryItem = svc ? BF.serviceGallery.find(g => g.sid === svc.id) : null;
              const beforeImg = galleryItem ? galleryItem.before : BF.pairs[p].before;
              const afterImg = galleryItem ? galleryItem.after : BF.pairs[p].after;
              const fit = "cover";
              
              return (
                <div className="gal-item reveal" key={p + i}>
                  <BA before={beforeImg} after={afterImg} ratio="4 / 3" start={0.5} afterFit={fit} beforeLabel="Before" afterLabel="After" beforeAlt={`${p} — before editing`} afterAlt={`${p} — after editing`} />
                  {svc && (
