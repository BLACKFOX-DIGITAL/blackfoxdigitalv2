...
export function TrialPage({ service }) {
  ...
  const steps = [
    { n: "01", icon: "free",     t: "Upload up to 5 images", d: "Drop your photos and tell us the look you're after — RAW or JPEG, any service." },
  ...
  const chips = ["No credit card", "Up to 5 images free", "24–48h turnaround", "NDA-secured"];
    ...
    <main className="page-intro trial">
      ...
      <section className="trial-hero">
        <div className="shell">
          ...
          <h1 className="display trial-h1">Send five images.<br/>See the <span className="red">difference.</span> Free.</h1>
          <p className="lede trial-lede">
            Not sure we're the right editing desk? Don't take our word for it. Send up to five photos and
        ...
        <div className="shell trial-grid">
          ...
          <div className="trial-info">
            ...
            <div className="trial-proof">
              <div className="trial-proof-ba">
                <BA before={BF.pairs.model.before} after={BF.pairs.model.after} ratio="5 / 3" start={0.5} afterFit="cover" beforeLabel="Your RAW" afterLabel="What we send back" beforeAlt="Model photo — raw file submitted by client" afterAlt="Model photo — free trial edit returned by BLACKFOX DIGITAL" auto autoDelay={500} />
              </div>
          ...
          <div className="trial-form-wrap">
            <form className="trial-card" onSubmit={submit} noValidate>
              ...
              <div className="field">
                <label>Your images <span style={{ color: "var(--red)", letterSpacing: 0 }}> · up to 5 free</span></label>
                <div
                ...
                >
                  ...
                  <span className="drop-sub">JPEG, PNG or RAW · up to 5 files</span>
                </div>
                {files.length > 0 && (
